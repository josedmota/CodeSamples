...
from PushDataPowerBi import pushToServer
...
class Agent:
    def __init__(self, state_size):
        ...
        self.min_learning_rate  = 0.001 # added for variable learning rate
        self.gamma              = 0.95
    ...
    def _buildActionList(self):
       ...
       for  u in range(10,90,10):#original is 0,100,10
           for v in range(10,90,10):#original is 0,100,10
               for rot in range(0,90,90):
                   if (u==10 and v==10 and rot ==0):
            ...
            for index_episode in range(self.episodes):
                ...
                while not done:
                    ...
                    if not ActionSent and AgentLearned: #send action to file
                        ...
                        self.agent.prevActions.append(action)
                ...
                self.agent.clear_prevActions() # clear prev actions list
                try:
                    pushToServer(0,score) # remove this to stop pushing data to PowerBI
                except:
                    None
